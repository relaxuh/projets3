<?php
    ...
    echo "Expediteur : ".$email." (".$expediteur."), Objet : ".$objet."<br />&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a href='index.php?param=unMessage.php&msg=".$ligne['id']."'>voir (".$lu.")</a><br /><br /><br />";
  }
?>